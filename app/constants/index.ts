...
export const RIGHT_CONFETTI = {
 ...
 export const user = { name: "dia" };

 export const dashboardstats = {
    totalUsers: 7982,
    usersJoined: { currentMonth: 453, lastMonth: 365 },
    totalTrips: 3210,
    tripsCreated: { currentMonth: 192, lastMonth: 268 },
    userRole: { total: 73, currentMonth: 39, lastMonth: 21 },
  };
